...
S {}
E {}
N -110 -30 -50 -30 {lab=VDD}
N 250 -30 270 -30 {lab=X}
N 250 -10 270 -10 {lab=Y}
N 270 -30 320 -30 {lab=X}
N 270 -10 320 -10 {lab=Y}
...
C {devices/opin.sym} 320 -30 0 0 {name=p1 lab=X}
C {devices/opin.sym} 320 -10 0 0 {name=p2 lab=Y}
...
* Plot output node voltage(s)
plot v(X) v(Y) v(Vctrl)
...
"}
C {devices/lab_wire.sym} -70 -30 0 0 {name=p3 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} -50 70 0 0 {name=p4 sig_type=std_logic lab=Vctrl}
C {devices/lab_wire.sym} 300 -30 0 0 {name=p5 sig_type=std_logic lab=X}
C {devices/lab_wire.sym} 300 -10 0 0 {name=p6 sig_type=std_logic lab=Y}
